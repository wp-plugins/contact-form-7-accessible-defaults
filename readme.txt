...
That's all this does. It replaces the default template that Contact Form 7 automatically generates with an accessible equivalent of that form. It doesn't change anything about your current forms built with Contact Form 7.
